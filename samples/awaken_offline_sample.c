...
{
	const char *keyword_file = "./res/2020072016425225.dat";               // SET
	const char *audio_pcm_file = "./audio/test1.raw";               // SET
	const char *appid = "411ef3c0b1ac7992fd6d9aeca09970b6";        // SET
	const char *pwd = "123456";                                       // SET
	...
	wakeupObj = wakeupInit(FRAMElEN,keyword_file, model_bin_file, appid, pwd);
	if (!wakeupObj)
	{
